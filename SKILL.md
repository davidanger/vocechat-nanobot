...
always: true
metadata: {"emoji":"💬","category":"communication","api_base":"https://voce.chat/api","status":"stable","release_date":"2026-02-24","authors":["davidanger","nanobot-354345126"]}
---
...
| `webhookPort` | integer | 否 | Webhook 端口（默认 8080） |
...
**有问题？** 查看 `QUICKSTART.md` 或检查日志 `/tmp/vocechat_webhook.log`立服务
- ✅ **双向消息通信** - 发送和接收消息
- ✅ **智能自动回复** - 基于 nanobot AI 能力
- ✅ **Markdown 支持** - 格式化消息
- ✅ **新用户欢迎** - 自动欢迎新用户
